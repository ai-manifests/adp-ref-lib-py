...
[![PyPI](https://img.shields.io/pypi/v/adp-manifest.svg?label=PyPI)](https://pypi.org/project/adp-manifest/)
[![Downloads](https://img.shields.io/pypi/dm/adp-manifest.svg)](https://pypi.org/project/adp-manifest/)
[![Python](https://img.shields.io/badge/python-3.10%2B-blue.svg)](https://pypi.org/project/adp-manifest/)
...
This library is one of several reference implementations ([TypeScript](https://github.com/ai-manifests/adp-ref-lib-ts)) of the same spec. The spec itself is at [adp-manifest.dev](https://adp-manifest.dev) and is the source of truth; this library implements what the spec says.
